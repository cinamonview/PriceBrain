"""List GPU targets with recent price decreases."""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="List GPU targets with price decreases.")
    ...
    try:
        ...
        summaries = view.list_price_drops(filters=parse_price_filters(args))
    ...
    print(format_price_summary_list(summaries, title="GPU Price Drops"))
    return 0
